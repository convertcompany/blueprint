        ...
        {open ? (
          <DialogPrimitive.Root open={open} onOpenChange={openChange}>
            <DialogPrimitive.Portal forceMount>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                <DialogPrimitive.Content forceMount className={"fixed left-[50%] top-[50%] z-50 w-[95vw] max-w-md -translate-x-[50%] -translate-y-[50%] rounded-2xl bg-white p-6 focus:outline-none md:w-full"}>
                  {props.children}
