...
const LoadingPage = (props: LoadingPageProps) => {
  const { title = "Carregando...", subtitle = "Por favor, aguarde!" } = props;
  return (
    <AnimatePresence>
      <div className="flex h-screen w-screen grow flex-col items-center justify-center bg-gray-50">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col items-center justify-center">
          <div role="status">
            <svg aria-hidden="true" className="mb-6 inline h-12 w-12 animate-spin fill-gray-800 text-gray-200" viewBox="0 0 100 101" fill="none" xmlns="http:www.w3.org/2000/svg">
