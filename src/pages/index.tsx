          ...
          {isLoading ? (
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-6 transition-all">
                <div className="relative flex grow select-none items-center gap-4 overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 antialiased shadow-sm outline-none ring-blue-500 ring-offset-2 transition-all hover:shadow-md focus-visible:ring-2 active:shadow-none" tabIndex={0}>
        ...
        {!!blueprint?.authorId && (
          <div className="mt-2 flex items-center gap-2">
            ...
            <p className="text-xs font-medium text-slate-500 ">
              Criado por {blueprint.author.fullName} • {dayjs(blueprint.createdAt).fromNow()}
            </p>
          </div>
        )}
      </div>
